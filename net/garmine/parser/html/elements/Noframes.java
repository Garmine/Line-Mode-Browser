...
import net.garmine.parser.html.attributes.Ltr;
...
public class Noframes extends Element {
	public  class;
	public  dir;
	public  ltr;
	public  id;
	...
	public Noframes(Element parent, HtmlAttributeToken[] attrs){
		super(parent, attrs);
