...
import net.garmine.network.ResponseType;
...
public final class Request implements Runnable {
	 ...
	 */
	Request(String url, byte[] body, ReqMethod method, Network parent){
		PARENT = parent;
	 ...
	 * @throws IllegalStateException if Request has started
	 */
	public Request setMethod(ReqMethod method){
		forceNotStarted();
		this.method = method;
		return this;
	}
	 ...
	 * @throws IllegalStateException if Request has started
	 */
	public Request setType(ResponseType type) {
		forceNotStarted();
		if (type==null) throw new NullPointerException("Type mustn't be null !");
		if (type==ResponseType.ERROR) throw new IllegalArgumentException("Type mustn't be ERROR !");
		this.type = type;
		return this;
	}
	/**
	 ...
	 * @throws IllegalStateException if Request has started
	 */
	public Request setRequestProperty(HashMap<String, String> requestProperty) {
		forceNotStarted();
	 ...
	 * Changes type to ERROR and Data to a {@link NetworkException}.
	 * @param e - Exception which occurred
	 */
	private void exception(Exception e){
		data = new NetworkException(e);
		if(responseCode == 0){
			responseCode = -1;
			responseMessage = null;
		}
